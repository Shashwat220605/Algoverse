...
export default function AlgorithmWorkspace() {
  ...
  const [arrayInput, setArrayInput] =
    useState(
      defaultLinearSearchArray.join(", ")
    );

  const [targetInput, setTargetInput] =
    useState(
      String(defaultLinearSearchTarget)
    );
  ...
  useEffect(() => {
    ...
    if (algorithm === "binarySearch") {
      setArrayInput(
        defaultBinarySearchArray.join(", ")
      );
      setTargetInput(
        String(defaultBinarySearchTarget)
      );
      setSteps(
        createBinarySearchTrace(
          defaultBinarySearchArray,
    ...
    if (algorithm === "insertionSort") {
      setArrayInput(
        defaultInsertionSortArray.join(", ")
      );
      setTargetInput("");
      setSteps(
        createInsertionSortTrace(
    ...
    if (algorithm === "selectionSort") {
      setArrayInput(
        defaultSelectionSortArray.join(", ")
      );
      setTargetInput("");
      setSteps(
        createSelectionSortTrace(
    ...
    if (algorithm === "linkedListTraversal") {
      setArrayInput(
        defaultLinkedListArray.join(", ")
      );
      setTargetInput("");
      setSteps(
        createLinkedListTraversalTrace(
    ...
    if (algorithm === "linkedListInsertion") {
      setArrayInput(
        defaultLinkedListInsertionArray.join(", ")
      );
      setTargetInput(
        `${defaultLinkedListInsertionValue}, ${defaultLinkedListInsertionPosition}`
      );
      setSteps(
        createLinkedListInsertionTrace(
          defaultLinkedListInsertionArray,
    ...
    if (algorithm === "linkedListDeletion") {
      setArrayInput(
        defaultLinkedListDeletionArray.join(", ")
      );
      setTargetInput(
        String(defaultLinkedListDeletionPosition)
      );
      setSteps(
        createLinkedListDeletionTrace(
          defaultLinkedListDeletionArray,
    ...
    if (algorithm === "stackPush") {
      setArrayInput(
        defaultStackArray.join(", ")
      );
      setTargetInput(
        String(defaultStackPushValue)
      );
      setSteps(
        createStackPushTrace(
          defaultStackArray,
    ...
    if (algorithm === "stackPop") {
      setArrayInput(
        defaultStackPopArray.join(", ")
      );
      setTargetInput("");
      setSteps(
        createStackPopTrace(
    ...
    if (algorithm === "stackPeek") {
      setArrayInput(
        defaultStackPeekArray.join(", ")
      );
      setTargetInput("");
      setSteps(
        createStackPeekTrace(
    ...
    if (algorithm === "queueEnqueue") {
      setArrayInput(
        defaultQueueArray.join(", ")
      );
      setTargetInput(
        String(defaultQueueEnqueueValue)
      );
      setSteps(
        createQueueEnqueueTrace(
          defaultQueueArray,
    ...
    if (algorithm === "queueDequeue") {
      setArrayInput(
        defaultQueueDequeueArray.join(", ")
      );
      setTargetInput("");
      setSteps(
        createQueueDequeueTrace(
    ...
    if (algorithm === "queueFront") {
      setArrayInput(
        defaultQueueFrontArray.join(", ")
      );
      setTargetInput("");
      setSteps(
        createQueueFrontTrace(
    ...
    if (algorithm === "binaryTreePreorder") {
      setArrayInput(
        defaultBinaryTreeArray.join(", ")
      );
      setTargetInput("");
      setSteps(
        createBinaryTreePreorderTrace(
    ...
    if (algorithm === "binaryTreeInorder") {
      setArrayInput(
        defaultBinaryTreeInorderArray.join(", ")
      );
      setTargetInput("");
      setSteps(
        createBinaryTreeInorderTrace(
    ...
    if (algorithm === "binaryTreePostorder") {
      setArrayInput(
        defaultBinaryTreePostorderArray.join(", ")
      );
      setTargetInput("");
      setSteps(
        createBinaryTreePostorderTrace(
    ...
    if (algorithm === "binaryTreeLevelOrder") {
      setArrayInput(
        defaultBinaryTreeLevelOrderArray.join(", ")
      );
      setTargetInput("");
      setSteps(
        createBinaryTreeLevelOrderTrace(
    ...
    if (algorithm === "buildMaxHeap") {
      setArrayInput(
        defaultBuildMaxHeapArray.join(", ")
      );
      setTargetInput("");
      setSteps(
        createBuildMaxHeapTrace(
    ...
    if (algorithm === "heapInsert") {
      setArrayInput(
        defaultHeapInsertArray.join(", ")
      );
      setTargetInput(
        String(defaultHeapInsertValue)
      );
      setSteps(
        createHeapInsertTrace(
          defaultHeapInsertArray,
    ...
    if (algorithm === "heapExtractMax") {
      setArrayInput(
        defaultHeapExtractMaxArray.join(", ")
      );
      setTargetInput("");
      setSteps(
        createHeapExtractMaxTrace(
    ...
    if (algorithm === "bstInsert") {
      setArrayInput(
        defaultBSTInsertArray.join(", ")
      );
      setTargetInput(
        String(defaultBSTInsertValue)
      );
      setSteps(
        createBSTInsertTrace(
          defaultBSTInsertArray,
    ...
    if (algorithm === "bstSearch") {
      setArrayInput(
        defaultBSTSearchArray.join(", ")
      );
      setTargetInput(
        String(defaultBSTSearchTarget)
      );
      setSteps(
        createBSTSearchTrace(
          defaultBSTSearchArray,
    ...
    if (algorithm === "bstDelete") {
      setArrayInput(
        defaultBSTDeleteArray.join(", ")
      );
      setTargetInput(
        String(defaultBSTDeleteValue)
      );
      setSteps(
        createBSTDeleteTrace(
          defaultBSTDeleteArray,
  ...
  const runAlgorithm = () => {
    ...
    if (
      ...
      const graph =
        parseGraphInput(arrayInput);

      if (
        Object.keys(graph).length === 0
      ) {
        setError(
          "Enter graph edges such as A-B, A-C, B-D."
        );
        return;
      }
    ...
    if (
      parsedArray.length > 30
    ) {
      setError(
        "Use 30 or fewer elements."
      );
      return;
    }
    ...
    if (
      ...
      if (
        ...
        setError(
          "Enter insertion as: value, position."
        );
        return;
      }
      ...
      if (
        ...
        position < 0 ||
        position > parsedArray.length
      ) {
        setError(
          `Position must be between 0 and ${parsedArray.length}.`
        );
        return;
      }
    ...
    if (algorithm === "queueEnqueue") {
      ...
      if (
        ...
        setError(
          "Enqueue value must be a number."
        );
        return;
      }
    ...
    if (
      ...
      if (
        ...
        setError(
          "Heap insert value must be a number."
        );
        return;
      }
    ...
    if (
      ...
      if (
        ...
        setError(
          "BST insert value must be a number."
        );
        return;
      }
    ...
    if (
      ...
      if (
        ...
        setError(
          "BST search value must be a number."
        );
        return;
      }
    ...
    if (
      ...
      if (
        ...
        setError(
          "BST delete value must be a number."
        );
        return;
      }
  ...
  return (
    <main className="flex h-screen flex-col overflow-hidden bg-[#050505] text-white">
      ...
      <header className="relative z-50 flex min-h-16 shrink-0 flex-wrap items-center justify-between gap-4 border-b border-white/10 bg-[#080808] px-6 py-3">
        ...
        <div className="flex items-center gap-6">
          ...
          <select
            ...
            className="rounded-lg border border-white/10 bg-[#09090b] px-3 py-2 text-sm text-white outline-none focus:border-violet-500/50"
          >

            {ALGORITHM_GROUPS.map(
              (group) => (
                <optgroup
                  key={group.label}
                  label={group.label}
      ...
      {error && (
        <div className="relative z-40 shrink-0 border-b border-red-500/20 bg-red-500/5 px-6 py-2 text-center text-xs text-red-400">
          {error}
        </div>
      )}
      ...
      <section className="grid min-h-0 flex-1 grid-cols-1 overflow-auto lg:grid-cols-[1.5fr_0.9fr_0.85fr] xl:overflow-hidden">
        ...
        <div className="relative min-h-[600px] border-b border-white/10 lg:min-h-0 lg:border-b-0 lg:border-r">
          ...
          <div className="absolute bottom-5 left-5 right-5 z-20 rounded-2xl border border-white/10 bg-black/70 p-4 shadow-2xl backdrop-blur-xl">
            ...
            <div className="flex flex-col gap-3 md:flex-row">
              ...
              <div className="flex-1">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/10 bg-white/5 px-3 py-2.5 font-mono text-xs text-white outline-none placeholder:text-gray-700 focus:border-violet-500/50"
                  placeholder={
                    algorithm ===
                      "bfs" ||
                    algorithm ===
              ...
              <div className="flex items-end">
                ...
                <button
                  ...
                  className="w-full rounded-xl bg-violet-600 px-5 py-2.5 text-xs font-medium transition hover:bg-violet-500 md:w-auto"
                >
                  Run Algorithm
                </button>
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              ...
              <span className="mr-1 self-center text-[10px] uppercase tracking-widest text-gray-600">
                Presets
              </span>
              ...
              {algorithm ===
                ...
                <>
                  <button
                    ...
                    className="rounded-lg border border-white/10 bg-white/5 px-3 py-1.5 text-[10px] text-gray-400 hover:bg-white/10 hover:text-white"
                  >
                    Default
                  </button>
        ...
        <div className="min-h-[400px] border-b border-white/10 lg:min-h-0 lg:border-b-0 lg:border-r">
        ...
        <div className="min-h-[450px] overflow-y-auto lg:min-h-0">
          ...
          <div className="space-y-3 p-3">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-4">
              ...
              <div className="mb-3 flex items-center justify-between">
                ...
                <div className="rounded-lg border border-violet-500/20 bg-violet-500/10 px-2 py-1 text-xs text-violet-300">
                  {currentAlgorithm.complexity}
                </div>
              ...
              <p className="text-xs leading-5 text-gray-500">
                Follow the visualization step by step to understand how the algorithm operates.
              </p>
      ...
      <div className="relative z-30 shrink-0 border-t border-white/10 bg-[#09090b]">
